package 
{
	...
	{
		[Embed(source = "../assets/circuitscreen2/screen.png")] 
		public static var Screen:Class;
		
		[Embed(source = "../assets/circuitscreen2/battery_vertical.png")] 
		public static var BatteryVertical:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_bottomleftcorner.png")] 
		public static var WireCorner4:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_bottomrightcorner.png")] 
		public static var WireCorner3:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_topleftcorner.png")] 
		public static var WireCorner1:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_toprightcorner.png")] 
		public static var WireCorner2:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_horizontal.png")] 
		public static var WireHorizontal:Class;
		
		[Embed(source = "../assets/circuitscreen2/Blackwire_vertical.png")] 
		public static var WireVertical:Class;
		
		[Embed(source = "../assets/circuitscreen2/Lightbulb_horizontal.png")] 
		public static var LightBulbHorizontal:Class;
		
		[Embed(source = "../assets/circuitscreen2/Lightbulb_vertical.png")] 
		public static var LightBulbVertical:Class;
		
		[Embed(source = "../assets/circuitscreen2/Resistor_horizontal.png")] 
		public static var ResistorHorizontal:Class;
		
		[Embed(source = "../assets/circuitscreen2/Resistor_vertical.png")] 
