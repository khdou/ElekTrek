package  
{
    import org.flixel.*;
    /**
     * A template for the Overworld
     * @author Kevin
     */
    public class AbstractOverworld extends FlxGroup
    {
        /**
         * Map
         */
         ...
         */
        public function AbstractOverworld(state:FlxState, levelSize:FlxPoint, tileSize:FlxPoint):void {
            super();
            this.state = state;
