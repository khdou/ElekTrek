	...
	public class PracticeClass5 extends AbstractPracticeProblem
	{
		...
		public function PracticeClass5() 
		{
			config1 = [
				...
				new Item("WireCorner3", 3, 4, -1, false),
				new Item("WireHorizontal", 1, 3, -1, false),
				new Item("WireHorizontal", 1, 4, -1, false),
				new Item("WireCorner4", 0, 4, -1, false),
		...
		public function getCircuitConfig(): Array 
		{
			...
			var index4 = Math.floor(Math.random() * resistors.length);
			while (index4 == index1 || index4 == index2 || index4 == index3)
				var index3 = Math.floor(Math.random() * resistors.length);
			
			R = Math.round(1/(1/resistors[index1] + 1/resistors[index2]) + 1/(1/resistors[index3] + 1/resistors[index4]) ) ;
		...
		public function isCorrect(): Boolean 
		{
			...
			var missingComp4 = CircuitInteractionState.getItem(2,4);
