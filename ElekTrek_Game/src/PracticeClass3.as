package
{
	...
	public class PracticeClass3 extends AbstractPracticeProblem
	{
		...
		public function PracticeClass3() 
		{
			...
			dialogue = "Now there are three missing resistors! Remember, when resistors are placed in the same loop(in series), the total resistance of the loop is the sum of the individual resistances. ";
		}
